...
namespace Microsoft.EntityFrameworkCore.Internal
{
    ...
    public static class RelationalStrings
    {
        ...
        /// <summary>
        /// Translation for method '{function}' used by this database provider can return incorrect results when the value argument contains wildcard characters (e.g. '%' or '_').
        /// </summary>
        ...
        {
            return string.Format(CultureInfo.CurrentCulture, GetString("KeyHasDefaultValue", "property", "entityType"), property, entityType);
        }
